...
{
    public static class StaticHubMethodNames
    {
        public static string ReceiveConnectSockets = "ReceiveConnectSockets";
        public static string SendPlayerListUpdate = "PlayerListUpdate";
